  ...
  return (
    <section className="relative min-h-[180vh] py-12 md:py-20">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative text-center mb-12 md:mb-16">
          ...
          >
            ...
            <motion.button
              ...
              className="mt-2 w-12 h-12 rounded-full border-2 border-teal-500/50 bg-teal-500/10 flex items-center justify-center text-teal-600 hover:bg-teal-500/20 hover:border-teal-500 transition-colors"
              animate={{ y: [0, 6, 0] }}
        ...
        <div id="change-your-system" className="relative scroll-mt-8">
          <HeroTransformation />
        </div>
      </div>
    </section>
